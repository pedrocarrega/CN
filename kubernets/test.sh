...
aws iam create-role --role-name eksServiceRole --assume-role-policy-document eks-service-role/assume-role.json --description "Allows EKS to manage clusters on your behalf."
