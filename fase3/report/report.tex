...
\begin{table}[htbp]
	...
	\begin{center}
		\begin{tabular}{|c|c|}
		\hline
			\textbf{\textit{Functionality}} & \textbf{\textit{Description}}\\ \hline
			\textbf{\textit{Available Catagories}} & \textbf{\textit{Service that provides the client with all the available catagories present on the dataset}} \\ \hline
			\textbf{\textit{GPU}} & \textbf{\textit{1127MHz}} \\ \hline
	\end{tabular}
	\label{tab1}
	\end{center}
\end{table}
