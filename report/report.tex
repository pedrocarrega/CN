...
\begin{enumerate}
	\item Usar o seguinte comando que listará os comandos que irão ser usado nos próximos comandos. \textbf{kubectl get svc --all-namespaces}
	\item Apagar todos os serviços listados pelo comando anterior com o seguinte comando, \textbf{kubectl delete svc <service-name>}
	...
	\item Executar o comando \textbf{eksctl delete cluster -{}-name=<cluster-name>} que será responsável por desmantelar os componentes criados no início do script.
